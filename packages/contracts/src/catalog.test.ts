...
describe("error codes", () => {
  it.each(["not_a_member", "not_joined", "forbidden", "couch_not_found", "media_unavailable", "already_joined", "internal_error", "host_cannot_leave", "cannot_remove_self", "couch_closed"])(
